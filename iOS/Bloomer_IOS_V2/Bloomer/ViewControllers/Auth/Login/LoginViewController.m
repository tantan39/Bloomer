...
- (void) setUp {
    ...
    [self.btnSignInFB setTitle:[AppHelper getLocalizedString: @"login.signFBLabel"] forState:UIControlStateNormal];
    ...
    [self.btnSignInFB.layer setCornerRadius:4];
...
- (void)keyboardWillShow:(NSNotification *) notif
{
    ...
    CGFloat yFrame = self.view.bounds.size.height - (self.viewParentBtnSignIn.frame.origin.y + self.btnSignIn.frame.origin.y + self.btnSignIn.bounds.size.height  - self.navigationController.navigationBar.bounds.size.height);

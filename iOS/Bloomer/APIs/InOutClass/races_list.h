...
@property (strong, nonatomic) NSString *topBannerArticle;
@property (strong, nonatomic) NSString *topBannerLink;
...
- (id)initWithName:(NSString *)name
    ...
    countryAvatars:(NSArray *) countryAvatars
               gsb:(NSInteger)gsb
  topBannerArticle:(NSString*)topBannerArticle
	 topBannerLink:(NSString*)topBannerLink;

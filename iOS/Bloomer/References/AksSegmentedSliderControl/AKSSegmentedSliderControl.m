...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIImage *imageToUse = [UIImage imageNamed:@"Holders"];
...
- (void)drawRect:(CGRect)rect {
    ...
    [self fillRect:drawingRect withColor:[UIColor colorWithRed:0.89 green:0.31 blue:0.31 alpha:1.0].CGColor onContext:_context];

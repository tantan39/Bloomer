...
- (void)setDefaults
{
    ...
    self.placeholderColor = [UIColor rgb:68 green:68 blue:68];
    self.placeholderFont = self.defaultPlaceholderFont;

    self.underlineHeight = 1.0f;
    self.underlineColor = [UIColor rgb:245 green:245 blue:245];
    self.underlineEditingHeight = 1.75f;

    self.errorColor = [UIColor rgb:255 green:51 blue:51];
    self.errorFont = [self defaultErrorFont];
    
    [self setAnimatesPlaceholder:NO];
    self.isProfile = false;
}

- (void)setupTextField
{
    [self setTextColor:[UIColor rgb:68 green:68 blue:68]];
...
{
    _defaultPlaceholderColor = defaultPlaceholderColor ?: [UIColor rgb:68 green:68 blue:68];;
...
- (void) setLeftViewWithImage:(UIImage *) image{
    if (image) {
        ...
        imageView.bounds = CGRectMake(0, 0, 16, 18);
...
//    CGFloat leftPadding = hasLeftView ? 0 : self.textPadding.width;
    CGFloat leftPadding = self.isPhoneNumberField ? 96 : 23;
    if (self.isProfile) {
        leftPadding = 5;
    }
    ...
    CGRect rect = CGRectMake(superRect.origin.x + leftPadding,
                             ...
                             superRect.size.width - rightPadding - leftPadding,

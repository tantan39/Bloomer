...
#define kTHANKYOU_STYLE_KEY 						@"thankyouStyle"
...
@property (nonatomic, assign) IBInspectable NSInteger thankyouStyle; // VL-ThankYouStyle : 0-tableviewcell ; 1-collectionviewcell;2-profile
...
@property (assign, nonatomic) BOOL showThankYou;

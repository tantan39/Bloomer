...
//    [draggable addSubview:_flowerValue];
    ...
    self.uploadPhotoView.layer.cornerRadius = self.uploadPhotoView.bounds.size.width/2;
    self.uploadPhotoView.clipsToBounds = YES;
}

- (void)setTabBarMode:(TabBarMode)mode{
    switch (mode) {
        case  Flower:{
            [self.uploadPhotoView setHidden:YES];
        ...
        case UploadPhoto:{
            [self.uploadPhotoView setHidden:NO];

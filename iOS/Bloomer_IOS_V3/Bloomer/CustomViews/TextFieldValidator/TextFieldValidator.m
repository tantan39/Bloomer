...
@synthesize presentInView,validateOnCharacterChanged,popUpColor,isMandatory,validateOnResign,paddingleft;

-(CGRect)textRectForBounds:(CGRect)bounds{
    return CGRectInset(bounds, paddingleft, 0);
};
...
-(void)showErrorIconForMsg:(NSString *)msg{
    ...
    if (msg) {
        [AppHelper showMessageBox:nil message:msg];
    }
}

...
+(NSString *)getrootURL
{
    NSString* result = [[AppSettings shareInstance] rootAPIURL];
    
//    result = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"ServerURL"];
//    if (url) { 
//
//    }
//
...
{
    NSString* result = [[AppSettings shareInstance] rootWebURL];
//    switch ([APIDefine getEnvironment]) {
//        case DEVELOPMENT:
...
{
    NSString* result = [[AppSettings shareInstance] rootChatURL];
//    switch ([APIDefine getEnvironment]) {
//        case DEVELOPMENT:
...
{
    NSString* result = [[AppSettings shareInstance] rootPhotoURL];
//    switch ([APIDefine getEnvironment]) {
//        case DEVELOPMENT:
...
+ (NSString *)hostSocket{
    ...
    NSString* result = [[AppSettings shareInstance] hostSocket];
//    switch ([APIDefine getEnvironment]) {
//        case DEVELOPMENT:

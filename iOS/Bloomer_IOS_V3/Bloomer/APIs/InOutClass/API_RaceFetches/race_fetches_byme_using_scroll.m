//
//  race_fetches_byme_using_scroll.m
//  Bloomer
//
...
#import "race_fetches_byme_using_scroll.h"

@implementation race_fetches_byme_using_scroll
...
- (void)processComplete:(jsonAbstractClass *)data {
    ...
    [self.myDelegate getDataRace_fetches_ByMe_Scroll:getData];
}
...
- (void)requestFailed:(ASIHTTPRequest *)request {
    ...
    [self.myDelegate Race_Fetches_ByMe_Scroll_RequestFailed:request];
}
